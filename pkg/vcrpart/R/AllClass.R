...
##
## Description:
## Defines S4 classes in the vcrpart package.
##
## Overview:
## olmm: class for ordinal 2-stage mixed models
## --------------------------------------------------------- #

setOldClass("family.olmm")
setOldClass("olmm_control")
...
setClass("olmm",
         representation(
           ...
           family = "family.olmm",   # model family
