...
\SweaveOpts{message=FALSE, prompt=TRUE, echo=TRUE, comment=NA, crop=TRUE, small.mar=TRUE, fig.align="center", fig.path="graphics/WC-", out.width=".8\\linewidth", concordance=TRUE} % sets the prefix for figure files generated par Sweave
